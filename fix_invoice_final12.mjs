...
content = content.replace(
  'className="flex flex-col w-[210mm] h-[148.5mm] print:w-[190mm] print:h-[128mm] print:max-h-[128mm] print:overflow-hidden print:break-inside-avoid bg-slate-50 md:bg-white shadow-none md:shadow-xl rounded-none md:rounded-xl mx-auto p-3 md:p-5 print:p-3 relative print:shadow-none text-slate-800 print:text-[0.85rem]"',
  'className="flex flex-col w-[210mm] h-[148.5mm] print:w-[210mm] print:h-[148.5mm] print:max-w-[210mm] print:max-h-[148.5mm] print:overflow-hidden print:break-inside-avoid print:scale-[0.93] print:origin-top bg-slate-50 md:bg-white shadow-none md:shadow-xl rounded-none md:rounded-xl mx-auto p-3 md:p-5 print:p-4 relative print:shadow-none text-slate-800 print:text-[0.85rem]"'
);
